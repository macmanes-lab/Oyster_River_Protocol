...
crbhpath := $(shell which crbh 2>/dev/null)

all: setup brew mcl shmlast hmmer orthofuser rcorrector blast spades trinity shannon seqtk busco trimmomatic transrate bowtie2 salmon postscript
