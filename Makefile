...
orthopath := $(bash conda activate py27; which orthofuser.py 2>/dev/null; conda deactivate)
orthufuserversion = $(bash conda activate py27; orthofuser.py --help | grep "OrthoFinder version" | awk '{print $$3}';conda deactivate)
