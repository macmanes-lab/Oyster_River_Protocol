...
ifdef conda
	...
	cd ${DIR}/software/anaconda && curl -LO https://repo.anaconda.com/archive/Anaconda3-5.3.1-Linux-x86_64.sh
	cd ${DIR}/software/anaconda && bash Anaconda3-5.3.1-Linux-x86_64.sh -b -p ${DIR}/software/anaconda/install
endif
