...
\usepackage[style=authoryear, minbibnames=99, maxbibnames=9, maxcitenames=9, natbib=true, backend=biber]{biblatex}
...
\centerline{\includegraphics[width=25.0\baselineskip]{Fig2.png}}
\begin{quote}
...
\centerline{\includegraphics[width=25.0\baselineskip]{Fig3.png}}
\begin{quote}
